...
Three recent, methodologically independent lines of evidence converge on
the same late-composition window.  First, Adler's comprehensive
archaeological survey of the material record finds no evidence for
widespread observance of Torah regulations --- dietary prohibitions,
miqvaot, stone-vessel purity practice --- before the mid-Hasmonean period
(mid-2nd century~BCE)~\cite{Adler2022}.  If the Torah had functioned as a
widely observed legal code since the pre-exilic or early post-exilic
period, the near-total absence of its material correlates for several
subsequent centuries requires explanation; Adler concludes instead that
the Torah achieved normative authority only in the Hasmonean period,
consistent with our model returning Persian-period dates for the final
written forms of P and D.  Second, epigraphic analysis of Achaemenid-era
Aramaic sources places the crystallization of distinctively Jewish legal
practice --- including Passover regulations that the Priestly source
legislates --- under Persian imperial influence in the 5th--4th
centuries~BCE, pointing to that same window as the formative period of
the Torah's legal traditions~\cite{Barnea2026}.  Third, independent study
of the Moses tradition traces the figure to a 4th-century~BCE literary
construction drawing on Egyptian folk-heroic conventions, locating even
the narrative scaffolding of the Pentateuch in the late Persian or early
Hellenistic period~\cite{Adair2025}.  An older body of historical-critical
scholarship has similarly argued for Persian or Hellenistic final
composition on literary-historical grounds~\cite{Thompson1999,Lemche2008,Davies1992};
the three empirical lines above are independent of that tradition and rest
on material and philological evidence rather than literary-critical
inference.

Taken together, these strands of evidence --- material archaeology,
epigraphy, comparative mythology, and now computational linguistics ---
converge on the same chronological window under entirely different methods.
Our results constitute a fourth independent line of confirmation, drawn
from morphosyntactic and lexical feature distributions with no assumption
about Torah composition date built into the inference.  Precisely because
the computational method makes no use of historical, archaeological, or
narrative-critical evidence, agreement with those independent traditions
cannot be an artifact of shared assumptions; it constitutes a consilience
that strengthens each individual line of argument.
