...
760--167~BCE, the models place the Priestly source at 402--406~BCE under
scholarly and agnostic priors alike, a data-driven result (prior
sensitivity Class~D) suggesting
...
On the other hand, transmission-with-updating (scribal modernization of
...
On the other hand, shared vocabulary or grammatical constructions with
...
The overconfidence does not, however, change the paper's headline
...
register misclassification.  Under scholarly and agnostic priors alike, the Priestly source
is placed at 402--406~BCE (a data-driven result) and the Deuteronomic
